...
class TestJTMLLexer(unittest.TestCase):
    ...
    def test_crypto_generate_key_all_parameters(self):
        ...
        """
        code = r'define privateKey = generate_key type:"RSA", algorithm:"SHA256", size:2048\\'
        tokens = self.tokenize(code)
        expected_types = [
    ...
    def test_comment_handling(self):
        ...
        Example: // This is a comment
                \\
        """
        code = r'// This is a comment (useless extra characters) 123\\'
        tokens = self.tokenize(code)
        expected_types = []
        self.assertEqual([tok.type for tok in tokens], expected_types)
