...
def p_primary_expression_negative_int(p):
    '''primary_expression : MINUS INT_LITERAL'''
    p[0] = NumberLiteralNode(-p[2])

def p_primary_expression_negative_float(p):
    '''primary_expression : MINUS FLOAT_LITERAL'''
    p[0] = NumberLiteralNode(-p[2])
