...
from opalg.parser.control_flow import *
from opalg.parser.crypto import *
from opalg.parser.database import *
from opalg.parser.error_handling import *
from opalg.parser.expressions import *
from opalg.parser.functions_and_classes import *
from opalg.parser.jtml_elements import *
from opalg.parser.quantum import *
from opalg.parser.statements import *
from opalg.parser.types_and_parameters import *
from opalg.parser.variables_and_constants import *
...
def p_jtml_element(p):
    ...
    # Serialize jtml_element to string and parse with C++ parser:
    tag_name = p[2]
