...
from opalg.compiler.ast_nodes import IfStatementNode, WhileStatementNode, ForStatementNode, BinaryOperationNode, BlockNode, IdentifierNode, NumberLiteralNode
